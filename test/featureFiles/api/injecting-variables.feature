...
Feature:
	...
	Scenario: Setting body payload from file using variable
		Given I store the raw value ./test/fixtures/requestBody.xml as myFilePath in scenario scope
	...
	Scenario: should successfully validate json using schema
		Given I store the raw value ./test/fixtures/get-simple.schema as schemaPath in scenario scope
		When I GET /get
	...
	Scenario: should successfully validate json using the OpenAPI spec description
		Given I store the raw value ./test/fixtures/get-simple-swagger-spec.json as swaggerSpecPath in scenario scope
		When I GET /get
