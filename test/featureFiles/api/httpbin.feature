...
Feature:
  ...
  Scenario: Setting body payload from file
    Given I pipe contents of file ./test/fixtures/requestBody.xml to body
    When I POST to /post
  ...
  Scenario: should successfully validate json using the OpenAPI spec description
    When I GET /get
    Then response body should be valid according to openapi description GetResponse in file ./test/fixtures/get-simple-swagger-spec.json
  ...
  Scenario: should successfully pipe form parameters
    ...
    And I pipe contents of file ./test/fixtures/formparams to body
    When I POST to /post
    Then response code should be 200
